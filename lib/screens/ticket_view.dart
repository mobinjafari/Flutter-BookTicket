          ...
          children: [
                            ...
                            child: LayoutBuilder(
                              builder: (BuildContext , BoxConstraints ) {
                                return Flex(
                                  ...
                                  children: List.generate((BoxConstraints.constrainWidth()/6).floor(), (index) => const SizedBox(
            ...
            Container(
              ...
              child: Row(
                children: [
                  SizedBox(
                    height: 20 , width: 10 , child: DecoratedBox(
                  ...
                  Expanded(child: LayoutBuilder(builder: (BuildContext , BoxConstraints ) {
                    return Flex(
                      direction: Axis.horizontal,
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      mainAxisSize: MainAxisSize.max,
                      children: List.generate((BoxConstraints.constrainWidth()/15).floor(), (index) => const SizedBox(
                        width: 05 , height: 1,child: DecoratedBox(
                        decoration: BoxDecoration(
                            color: Colors.white
                        ),
                      ),
